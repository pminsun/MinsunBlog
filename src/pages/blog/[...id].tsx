...
import { HiArrowLeft, HiOutlineArrowCircleLeft, HiOutlineArrowCircleRight } from 'react-icons/hi'
...
import { BlockDetailData, BlockDetailResults, TableData, TableResults } from '@/InterfaceGather'

export default function blockDetail({ blockDetail, propertiesData, tableData }: BlockDetailData) {
  ...
  return (
    <>
      <Seo
        ...
        image={propertiesData.cover?.external?.url || propertiesData.cover?.file?.url}
      />
          ...
          >
            ...
            <div className="ml-4">
              ...
              <p className="font-bold md:w-48 whitespace-nowrap overflow-hidden text-ellipsis">
                {preTitle.length > 30 ? preTitle.slice(0, 30) + '...' : preTitle}
              </p>
            </div>
          </Link>
        )}
          ...
          >
            <div className="mr-4 flex flex-col items-end">
              ...
              <p className="font-bold md:w-48 whitespace-nowrap overflow-hidden text-ellipsis text-right">
                {nextTitle.length > 30 ? nextTitle.slice(0, 30) + '...' : nextTitle}
              </p>
            </div>
